// High-tech subtle UI sound synthesizer using Web Audio API
// Completely zero-dependency, works offline, lightweight
...
class SoundSystem {
  ...
  // Success chime when applying or copying link
  public playSuccess() {
    if (!this.enabled) return;
    try {
      this.init();
